...
public class GPUImagePinchDistortionFilter extends GPUImageFilter {
	...
	public GPUImagePinchDistortionFilter() {
		super(NO_FILTER_VERTEX_SHADER, SPHERE_REFRACTION_SHADER);
	}

	public GPUImagePinchDistortionFilter(float scale, float radius) {
		super(NO_FILTER_VERTEX_SHADER, SPHERE_REFRACTION_SHADER);
		this.mScale = scale;
		this.mRadius = radius;
	}
	
	public GPUImagePinchDistortionFilter(final String fragmentShader) {
