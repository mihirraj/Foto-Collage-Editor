...
public class GPUImageSphereRefractionFilter extends GPUImageFilter {
	...
	private float mRefraction = 0.71f;
	 
	public GPUImageSphereRefractionFilter() {
	      super(NO_FILTER_VERTEX_SHADER, SPHERE_REFRACTION_SHADER);
	}

	public GPUImageSphereRefractionFilter(final String fragmentShader) {
	...
	public void update() {
		...
		setFloat(mAspectRatioLocation, mAspectRatio);//1.0f//4/3.0f
