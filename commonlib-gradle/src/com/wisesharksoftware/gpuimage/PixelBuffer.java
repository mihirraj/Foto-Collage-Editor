...
public class PixelBuffer {
    ...
    public Void saveBitmap(String folderName, String fileName) {
        ...
        mRenderer.onDrawFrame(mGL);
        convertToBitmap(folderName, fileName);
        //return mBitmap;
        return null;
    }
    ...
    @SuppressLint("NewApi")
	private void convertToBitmap(String folderName, String fileName) {
        ...
        */
    	...
    	Buffer ib = (Buffer) AllocationMemory.allocNativeBuffer(mWidth * mHeight * 4);
        mGL.glReadPixels(0, 0, mWidth, mHeight, GL_RGBA, GL_UNSIGNED_BYTE, ib);
//        mBitmap = Bitmap.createBitmap(mWidth, mHeight, Bitmap.Config.ARGB_8888);
//        mBitmap.copyPixelsFromBuffer(ib);
       
        AllocationMemory.savePhotoOpenCV(folderName + "/" + fileName, true, 0, ib, mWidth, mHeight, false);
        //AllocationMemory.savePhotoOpenCV("/storage/sdcard0/Fisheye/OpenCVPhoto.jpg", true, 0, ib, mWidth, mHeight, false);
        
        AllocationMemory.freeNativeBuffer(ib);
        ib = null;
    }
}
