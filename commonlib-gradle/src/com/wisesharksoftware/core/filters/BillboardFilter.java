...
import com.wisesharksoftware.core.*;

import java.io.File;
import java.io.IOException;
import java.util.Map.Entry;

public class BillboardFilter extends Filter
{
    ...
    public BillboardFilter() {
    	filterName = FilterFactory.BILLBOARD_FILTER;
    }
    ...
    protected void onSetParams()
    {
        for( Entry<String, String> paramEntry : params.entrySet() )
        {
            ...
            else if( name.equals( PARAM_X0 ) )
            {
                setX0(Integer.parseInt(value));
            }
            else if( name.equals( PARAM_X1 ) )
            {
                setX1(Integer.parseInt(value));
            }
            else if( name.equals( PARAM_X2 ) )
            {
                setX2(Integer.parseInt(value));
            }
            else if( name.equals( PARAM_X3 ) )
            {
                setX3(Integer.parseInt(value));
            }
            else if( name.equals( PARAM_Y0 ) )
            {
                setY0(Integer.parseInt(value));
            }
            else if( name.equals( PARAM_Y1 ) )
            {
                setY1(Integer.parseInt(value));
            }
            else if( name.equals( PARAM_Y2 ) )
            {
                setY2(Integer.parseInt(value));
            }
            else if( name.equals( PARAM_Y3 ) )
            {
                setY3(Integer.parseInt(value));
            }
        }
    }
